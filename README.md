...
`Ansible` · `Git` · `GitHub Actions` · `Bazel` · `Jira` · `SonarQube` · `Helix QAC` · `CodeSonar` · `YAML` · `Zuul` · `JSON` · `Microsoft Visual Studio Code` · `Eclipse`
...
<p align="center">
<img src="assets/certifications.svg">
</p>
